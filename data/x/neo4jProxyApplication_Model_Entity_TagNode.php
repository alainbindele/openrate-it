...
class neo4jProxyApplication_Model_Entity_TagNode extends Application\Model\Entity\TagNode implements HireVoice\Neo4j\Proxy\Entity
{
    ...
    function getEntity()
    {
        $entity = new Application\Model\Entity\TagNode;
